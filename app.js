...
UI.prototype.addCustomer = function (customer) {
    ...
    div.innerHTML = ` <h4 class="person__name">${customer.name}</h4>
...
UI.prototype.showModal = function (event) {
    ...
    modalItem.style.backgroundImage = `url(/work-${id}.jpeg)`;
};
